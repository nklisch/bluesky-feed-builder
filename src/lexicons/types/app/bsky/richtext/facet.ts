...
export function isMain(v: unknown): v is Main {
  return isObj(v) && hasProp(v, "$type") && (v.$type === "app.bsky.richtext.facet#main" || v.$type === "app.bsky.richtext.facet");
}
...
export function isMention(v: unknown): v is Mention {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.richtext.facet#mention";
}
...
export function isLink(v: unknown): v is Link {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.richtext.facet#link";
}
...
export function isByteSlice(v: unknown): v is ByteSlice {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.richtext.facet#byteSlice";
}
