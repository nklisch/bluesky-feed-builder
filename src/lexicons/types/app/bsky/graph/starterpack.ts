...
export function isRecord(v: unknown): v is Record {
  return isObj(v) && hasProp(v, "$type") && (v.$type === "app.bsky.graph.starterpack#main" || v.$type === "app.bsky.graph.starterpack");
}
...
export function isFeedItem(v: unknown): v is FeedItem {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.graph.starterpack#feedItem";
}
