...
export function isListViewBasic(v: unknown): v is ListViewBasic {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.graph.defs#listViewBasic";
}
...
export function isListView(v: unknown): v is ListView {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.graph.defs#listView";
}
...
export function isListItemView(v: unknown): v is ListItemView {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.graph.defs#listItemView";
}
...
export function isStarterPackView(v: unknown): v is StarterPackView {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.graph.defs#starterPackView";
}
...
export function isStarterPackViewBasic(v: unknown): v is StarterPackViewBasic {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.graph.defs#starterPackViewBasic";
}
...
export function isListViewerState(v: unknown): v is ListViewerState {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.graph.defs#listViewerState";
}
...
export function isNotFoundActor(v: unknown): v is NotFoundActor {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.graph.defs#notFoundActor";
}
...
export function isRelationship(v: unknown): v is Relationship {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.graph.defs#relationship";
}
