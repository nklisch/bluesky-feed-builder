...
export function isSkeletonSearchPost(v: unknown): v is SkeletonSearchPost {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.unspecced.defs#skeletonSearchPost";
}
...
export function isSkeletonSearchActor(v: unknown): v is SkeletonSearchActor {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.unspecced.defs#skeletonSearchActor";
}
