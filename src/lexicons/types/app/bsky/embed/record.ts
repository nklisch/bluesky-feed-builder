...
export function isMain(v: unknown): v is Main {
  return isObj(v) && hasProp(v, "$type") && (v.$type === "app.bsky.embed.record#main" || v.$type === "app.bsky.embed.record");
}
...
export interface ViewRecord {
  ...
  likeCount?: number;
  quoteCount?: number;
  embeds?: (AppBskyEmbedImages.View | AppBskyEmbedVideo.View | AppBskyEmbedExternal.View | View | AppBskyEmbedRecordWithMedia.View | { $type: string; [k: string]: unknown })[];
  indexedAt: string;
  [k: string]: unknown;
}
