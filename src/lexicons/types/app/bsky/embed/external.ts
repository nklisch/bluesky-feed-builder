...
export function isMain(v: unknown): v is Main {
  return isObj(v) && hasProp(v, "$type") && (v.$type === "app.bsky.embed.external#main" || v.$type === "app.bsky.embed.external");
}
...
export function isExternal(v: unknown): v is External {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.embed.external#external";
}
...
export function isView(v: unknown): v is View {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.embed.external#view";
}
...
export function isViewExternal(v: unknown): v is ViewExternal {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.embed.external#viewExternal";
}
