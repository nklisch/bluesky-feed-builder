...
export function isMain(v: unknown): v is Main {
  return isObj(v) && hasProp(v, "$type") && (v.$type === "app.bsky.embed.video#main" || v.$type === "app.bsky.embed.video");
}
...
export function isCaption(v: unknown): v is Caption {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.embed.video#caption";
}
...
export function isView(v: unknown): v is View {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.embed.video#view";
}
