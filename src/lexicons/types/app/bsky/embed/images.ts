...
export function isMain(v: unknown): v is Main {
  return isObj(v) && hasProp(v, "$type") && (v.$type === "app.bsky.embed.images#main" || v.$type === "app.bsky.embed.images");
}
...
export function isViewImage(v: unknown): v is ViewImage {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.embed.images#viewImage";
}
