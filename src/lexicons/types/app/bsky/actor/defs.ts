...
export function isProfileViewBasic(v: unknown): v is ProfileViewBasic {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#profileViewBasic";
}
...
export function isProfileView(v: unknown): v is ProfileView {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#profileView";
}
...
export function isProfileViewDetailed(v: unknown): v is ProfileViewDetailed {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#profileViewDetailed";
}
...
export function isProfileAssociated(v: unknown): v is ProfileAssociated {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#profileAssociated";
}
...
export function isProfileAssociatedChat(v: unknown): v is ProfileAssociatedChat {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#profileAssociatedChat";
}
...
export function isViewerState(v: unknown): v is ViewerState {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#viewerState";
}
...
export function isKnownFollowers(v: unknown): v is KnownFollowers {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#knownFollowers";
}
...
export function isAdultContentPref(v: unknown): v is AdultContentPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#adultContentPref";
}
...
export function isContentLabelPref(v: unknown): v is ContentLabelPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#contentLabelPref";
}
...
export function isSavedFeed(v: unknown): v is SavedFeed {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#savedFeed";
}
...
export function isSavedFeedsPrefV2(v: unknown): v is SavedFeedsPrefV2 {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#savedFeedsPrefV2";
}
...
export function isSavedFeedsPref(v: unknown): v is SavedFeedsPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#savedFeedsPref";
}
...
export function isPersonalDetailsPref(v: unknown): v is PersonalDetailsPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#personalDetailsPref";
}
...
export function isFeedViewPref(v: unknown): v is FeedViewPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#feedViewPref";
}
...
export function isThreadViewPref(v: unknown): v is ThreadViewPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#threadViewPref";
}
...
export function isInterestsPref(v: unknown): v is InterestsPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#interestsPref";
}
...
export function isMutedWord(v: unknown): v is MutedWord {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#mutedWord";
}
...
export function isMutedWordsPref(v: unknown): v is MutedWordsPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#mutedWordsPref";
}
...
export function isHiddenPostsPref(v: unknown): v is HiddenPostsPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#hiddenPostsPref";
}
...
export function isLabelersPref(v: unknown): v is LabelersPref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#labelersPref";
}
...
export function isLabelerPrefItem(v: unknown): v is LabelerPrefItem {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#labelerPrefItem";
}
...
export function isBskyAppStatePref(v: unknown): v is BskyAppStatePref {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#bskyAppStatePref";
}
...
export function isNux(v: unknown): v is Nux {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.actor.defs#nux";
}
