...
export function isRecord(v: unknown): v is Record {
  return isObj(v) && hasProp(v, "$type") && (v.$type === "app.bsky.feed.post#main" || v.$type === "app.bsky.feed.post");
}
...
export function isTextSlice(v: unknown): v is TextSlice {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.post#textSlice";
}
