...
export function isViewerState(v: unknown): v is ViewerState {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#viewerState";
}
...
export function isFeedViewPost(v: unknown): v is FeedViewPost {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#feedViewPost";
}
...
export interface ReplyRef {
  root: PostView | NotFoundPost | BlockedPost | { $type: string; [k: string]: unknown };
  parent: PostView | NotFoundPost | BlockedPost | { $type: string; [k: string]: unknown };
...
export function isReasonRepost(v: unknown): v is ReasonRepost {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#reasonRepost";
}
...
export function isReasonPin(v: unknown): v is ReasonPin {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#reasonPin";
}
...
export interface ThreadViewPost {
  post: PostView;
  parent?: ThreadViewPost | NotFoundPost | BlockedPost | { $type: string; [k: string]: unknown };
  replies?: (ThreadViewPost | NotFoundPost | BlockedPost | { $type: string; [k: string]: unknown })[];
  [k: string]: unknown;
}

export function isThreadViewPost(v: unknown): v is ThreadViewPost {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#threadViewPost";
}
...
export function isNotFoundPost(v: unknown): v is NotFoundPost {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#notFoundPost";
}
...
export function isBlockedPost(v: unknown): v is BlockedPost {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#blockedPost";
}
...
export function isBlockedAuthor(v: unknown): v is BlockedAuthor {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#blockedAuthor";
}
...
export function isGeneratorView(v: unknown): v is GeneratorView {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#generatorView";
}
...
export function isGeneratorViewerState(v: unknown): v is GeneratorViewerState {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#generatorViewerState";
}
...
export interface SkeletonFeedPost {
  post: string;
  reason?: SkeletonReasonRepost | SkeletonReasonPin | { $type: string; [k: string]: unknown };
...
export function isSkeletonFeedPost(v: unknown): v is SkeletonFeedPost {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#skeletonFeedPost";
}
...
export function isSkeletonReasonRepost(v: unknown): v is SkeletonReasonRepost {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#skeletonReasonRepost";
}
...
export function isSkeletonReasonPin(v: unknown): v is SkeletonReasonPin {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#skeletonReasonPin";
}
...
export function isThreadgateView(v: unknown): v is ThreadgateView {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#threadgateView";
}
...
export function isInteraction(v: unknown): v is Interaction {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.feed.defs#interaction";
}
