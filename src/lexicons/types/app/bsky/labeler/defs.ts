...
export function isLabelerView(v: unknown): v is LabelerView {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.labeler.defs#labelerView";
}
...
export function isLabelerViewerState(v: unknown): v is LabelerViewerState {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.labeler.defs#labelerViewerState";
}
...
export function isLabelerPolicies(v: unknown): v is LabelerPolicies {
  return isObj(v) && hasProp(v, "$type") && v.$type === "app.bsky.labeler.defs#labelerPolicies";
}
