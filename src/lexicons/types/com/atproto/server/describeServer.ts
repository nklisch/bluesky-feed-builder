...
export function isLinks(v: unknown): v is Links {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.server.describeServer#links";
}
...
export function isContact(v: unknown): v is Contact {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.server.describeServer#contact";
}
