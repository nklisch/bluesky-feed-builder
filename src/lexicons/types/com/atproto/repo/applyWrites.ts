...
export function isCreate(v: unknown): v is Create {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.repo.applyWrites#create";
}
...
export function isUpdate(v: unknown): v is Update {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.repo.applyWrites#update";
}
...
export function isDelete(v: unknown): v is Delete {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.repo.applyWrites#delete";
}
...
export function isCreateResult(v: unknown): v is CreateResult {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.repo.applyWrites#createResult";
}
...
export function isUpdateResult(v: unknown): v is UpdateResult {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.repo.applyWrites#updateResult";
}
...
export function isDeleteResult(v: unknown): v is DeleteResult {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.repo.applyWrites#deleteResult";
}
