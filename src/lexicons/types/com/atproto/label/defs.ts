...
export function isLabel(v: unknown): v is Label {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.label.defs#label";
}
...
export function isSelfLabels(v: unknown): v is SelfLabels {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.label.defs#selfLabels";
}
...
export function isSelfLabel(v: unknown): v is SelfLabel {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.label.defs#selfLabel";
}
...
export function isLabelValueDefinition(v: unknown): v is LabelValueDefinition {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.label.defs#labelValueDefinition";
}
...
export function isLabelValueDefinitionStrings(v: unknown): v is LabelValueDefinitionStrings {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.label.defs#labelValueDefinitionStrings";
}

export function validateLabelValueDefinitionStrings(v: unknown): ValidationResult {
