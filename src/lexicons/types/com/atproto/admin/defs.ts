...
export function isStatusAttr(v: unknown): v is StatusAttr {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.admin.defs#statusAttr";
}
...
export function isAccountView(v: unknown): v is AccountView {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.admin.defs#accountView";
}
...
export function isRepoRef(v: unknown): v is RepoRef {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.admin.defs#repoRef";
}
...
export function isRepoBlobRef(v: unknown): v is RepoBlobRef {
  return isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.admin.defs#repoBlobRef";
}
